                  ...
                  <div class="panel-heading">
                    <div class="row">
                      ...
                      <div class="col col-xs-6 text-right">
                        <button type="button" class="btn btn-sm btn-primary btn-create" data-toggle='modal' data-target='#modal-registro'>Agregar</button>
                      </div>
                    </div>
                  </div>
                    ...
                    <table class="table table-striped table-bordered table-list" id="mytable">
                      <thead>
                        <tr>
                          ...
                          <th><div align="center">Facultad</div></th>
                    ...
                    <form role="form" action="include/control.php" method="post" ENCTYPE='multipart/form-data'>
                      ...
                      <div class="row">
                        <div class="col-xs-12 col-sm-12 col-md-12">
                          <label for="nameSignA">Nombre</label>
                          <div class="form-group">
                            <input type="text" name="nameSignB" id="nameSignB" class="form-control input-lg" placeholder="Nombre Completo" tabindex="1" autocomplete="off" required>
                          </div>
                        </div>
                      </div>
                        <div class="row">
                          <div class="col-xs-12 col-sm-6 col-md-4">
                            <label for="cedSignB">Cédula</label>
                            <div class="form-group">
                              <input type="text" name="cedSignB" id="cedSignB" class="form-control input-lg" placeholder="Cédula" tabindex="3" autocomplete="off" required readonly>
                            </div>
                          </div>
                          <?php
                            if($_SESSION['ROL']=="SUPER"){
        			                echo'
                              <label for="FacRB">Facultad</label>
                              <div class="col-xs-12 col-sm-6 col-md-8">
                                <div class="input-group input-group-lg"style="z-index:"0";>
                                  <input type="text" class="form-control" id="FacRB" name="FacRB" required>
                                  <div class="input-group-btn">
                                    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown"><span class="caret"></span></button>
                                    <ul class="dropdown-menu pull-right" role="menu" id="FacB">
                                      <li><a>ING. DE SISTEMAS COMPUTACIONALES</a></li>
                                      <li><a>ING. CIVIL</a></li>
                                      <li><a>ING. ELECTRICA</a></li>
                                      <li><a>ING. MECANICA</a></li>
                      ...
                      <div class="row">
                        <div class="col-xs-12 col-sm-6 col-md-6">
                          <label for="passwordSignB">Contraseña</label>
                          <div class="form-group">
                            <input type="password" name="passwordSignB" id="passwordSignB" class="form-control input-lg" placeholder="Contraseña" tabindex="5" required>
                          </div>
                        </div>
                        <div class="col-xs-12 col-sm-6 col-md-6">
                          <label for="passwordConfirmA">Confirmar Contraseña</label>
                          <div class="form-group">
                            <input type="password" name="passwordConfirmB" id="passwordConfirmB" class="form-control input-lg" placeholder="Confirmar Contraseña" tabindex="6" required>
                          </div>
                        </div>
                      </div>
                      <div class="container-fluid PREV">
                        <div class="row">
                          <div class="col-xs-12 col-md-10 col-sm-8 col-md-offset-1 col-sm-offset-2">
                            <div class="col-xs-6 col-xs-offset-3">
                              <input id="sinImgAV" name="sinImgAV" type="button" class="btn btn-md btn-danger" value="X">
                              <img src='' class='img-responsive img-circle center-block img-user' id="img_registerAV" style="height:175px; padding-top:15px;">
                              <div class="fileUpload btn btn-primary btn-block">
                                <span>Examinar</span>
                                <input id="uploadBtnAV" name="uploadBtnAV" type="file" class="upload" accept="image/jpeg"/>
                              </div>
                              <input id="uploadFileAV" placeholder="Escojer Archivo..." class="form-control" name="uploadFileAV" autocomplete="off" readonly value=""/>
                            </div>
                          </div>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6 col-md-offset-3"><input type="submit" value="Actualizar" class="btn btn-success btn-block btn-lg" name="botonActYoB" id="botonActYoB" tabindex="7">
                        </div>
                      </div>
                    </form>
                  </div>
